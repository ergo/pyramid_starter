...
class GroupsGrid(Grid):
    def __init__(self, *args, **kwargs):
        kwargs["columns"] = ["_numbered", "group_name", "description", "options"]
...
class GroupPermissionsGrid(Grid):
    def __init__(self, *args, **kwargs):
...
class UserPermissionsGrid(Grid):
    def __init__(self, *args, **kwargs):
        kwargs["columns"] = ["perm_name", "options"]
...
class ResourceUserPermissionsGrid(Grid):
    def __init__(self, *args, **kwargs):
...
class ResourceGroupPermissionsGrid(Grid):
    def __init__(self, *args, **kwargs):
